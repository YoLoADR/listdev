...
const langs = {
  en: {
    ...
    selectPersonHeading: 'Please choose number of persons for your booking',
    startDate: 'START',
    endDate: 'END',
    ThankYou: 'Thank you',
    FinishOrder:
    ...
    textEnd: 'Time End',
    timeStart: 'Choose Time Start',
    timeEnd: 'Choose Time End',
    ...
    selectOnCalendar: 'Please tap to calendar to pick the booking date ',
    ...
    location: 'Location',
    noListing: "You don't have any listings",
